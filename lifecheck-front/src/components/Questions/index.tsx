				...
				>
					<div className="-mt-24">
						...
						<div className="flex justify-center relative items-center pb-10">
							<p className="text-1xl text-center w-3/5">
								{descripcion}
								<p className="text-1xl text-center text-white -translate-y-5 blur-md">
									{descripcion}
								</p>
							</p>
						</div>
						...
						<div className="flex justify-center  pb-10">
							{!isListening ? (
								...
								<button
									...
									className="drop-shadow-lg hover:scale-125 duration-200"
								>
						...
						<div className="pb-10 flex justify-center items-start">
							<textarea
								className={
									showRed +
									'w-2/5 bg-white drop-shadow-lg duration-200 font-medium rounded-full px-4 pt-2 pb-12 rounded-lg text-left'
								}
							...
							<button
								...
								className="scale-50 hover:scale-75 duration-200 drop-shadow-lg"
							>
