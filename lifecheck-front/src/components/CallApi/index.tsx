    ...
    while (categoryChangingID < 8) {
      ...
      try {
        const res = await fetch(
          "https://w7jjh178z8.execute-api.us-east-2.amazonaws.com/default/myGaboFunction",
          {
            method: "POST",
            headers: {
            ...
            //body: '{"userIDkey": "2"}'
            body: JSON.stringify({
              userIDkey: paramUserID,
              categoryIDkey: categoryChangingID,
            }),
          },
        );
  ...
  return (
    <div>
      {showPB == false ? (
        <div>
          <button
            onClick={GenerarTodosLosResultados}
        ...
        <div>
          <p className="text-3xl text-center duration-200 mt-20">
