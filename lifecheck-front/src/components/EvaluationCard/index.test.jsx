...
describe('MyComponent', () => {
  test('Verifica que el ícono de Academia se renderiza cuando la categoría es "Educación"', () => {
    render(<MyComponent cardName="Educación" showedCategory="Educación" littleDown={false} toggleVisibility={() => {}} checkValue={0} />);
  ...
  test('Verifica que el botón es funcional y llama a la función toggleVisibility con "Educación" como argumento al ser clickeado', () => {
    ...
    render(<MyComponent cardName="Educación" showedCategory="" littleDown={false} toggleVisibility={toggleVisibilityMock} checkValue={0} />);
  ...
  test('Verifica que los estilos de fondo del componente cambian de "bg-white" a "bg-[#fbbf24]" al ser "Educación" la categoría mostrada', () => {
    const { rerender } = render(<MyComponent cardName="Educación" showedCategory="" littleDown={false} toggleVisibility={() => {}} checkValue={0} />);
    ...
    rerender(<MyComponent cardName="Educación" showedCategory="Educación" littleDown={false} toggleVisibility={() => {}} checkValue={0} />);
  ...
  test('Verifica la correcta renderización del ícono "QuestionMarkCircleIcon" cuando el valor de checkValue es 1', () => {
    render(<MyComponent cardName="Educación" showedCategory="Educación" littleDown={false} toggleVisibility={() => {}} checkValue={1} />);
