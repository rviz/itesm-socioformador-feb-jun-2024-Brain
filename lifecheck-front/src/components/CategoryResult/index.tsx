                  ...
                  >
                    ...
                    >
                      <div className="flip-card-inner">
                        <div
                          className={`flip-card-front ${colorFront} border border-grey-150 px-4 rounded-lg shadow-xl flex flex-col items-center justify-center`}
                        >
                        ...
                        <div
                          className={`flip-card-back ${colorBack} text-white font-bold p-4 rounded-lg shadow-lg flex flex-col items-center justify-center`}
                        >
                          <p
